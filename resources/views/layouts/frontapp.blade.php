                                ...
                                <div class="advance_serach">
                                    <div class="select_option mb-0 clearfix">
                                        <select class="nice_select" name="category">
                                            <option data-display="All Categories" disabled selected>Select A Category</option>
                                    ...
                                    <div class="form_item">
                                        <input type="search" value="{{ request()->search ?? '' }}" name="search" placeholder="Search Prudcts...">
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="collapse  {{ request()->routeIs('frontend.index') ? 'show': '' }}" id="allcategories_collapse">
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                        ...
                                        <li><a class="nav-link" href="{{ route('frontend.contact.index') }}">Contact Us</a></li>
                                    </ul>
                                </div>
                            </nav>
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{ asset($cart->product->galleries->first()->image_path) }}" alt="image_not_found">
                            </div>
            ...
            <section class="newsletter_section">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-lg-6">
                            <form action="{{ route('frontend.email.store') }}" method="POST">
                                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-2 col-md-3 col-sm-6">
                            <div class="footer_widget footer_useful_links">
                                ...
                                <ul class="ul_li_block">
                                    <li><a href="{{ route('frontend.user.dashboard') }}">My Account</a></li>
                                    <li><a href="#!">Orders</a></li>
                                    <li><a href="{{ route('frontend.product.cart.list') }}">My Cart</a></li>
                                </ul>
                            </div>
                        </div>
                        @endif
