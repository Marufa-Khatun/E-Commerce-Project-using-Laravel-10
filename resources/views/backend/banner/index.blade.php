                        ...
                        <tr>
                         ...
                         <td>
                             <div class="d-flex justify-content-end flex-shrink-0">
                                 <a href="{{ route('backend.productmanagement.service.show', $banner->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                 ...
                                 <a href="{{ route('backend.productmanagement.banner.edit', $banner->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                 ...
                                 <form method ="POST" action="{{ route('backend.productmanagement.banner.destroy', $banner->id) }}">
                                     @csrf
                                     @method('delete')
...
<div class="col-xl-4">
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-body py-3">
                <form action="{{ route('backend.productmanagement.banner.store') }}" method="POST" enctype="multipart/form-data" >
                    @csrf
