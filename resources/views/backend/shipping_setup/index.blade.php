                    ...
                    <tbody>
                           @foreach ($shippings as $shipping)
                               <tr>
                                ...
                                <td>{{ $shipping->add_price ?? "Free" }}</td>
                                <td>{{ $shipping->created_at->format('d Y M') }}</td>
                                <td>
...
<div class="col-xl-4">
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Create Shipping</span>  
            </h3>
        </div>
        
            
            <div class="card-body py-3">
                <form action="{{ route('backend.productmanagement.shippingsetup.store') }}" method="POST" >
                    @csrf
                    <div class="fv-row mb-9 fv-plugins-icon-container">
                        <label class="fs-6 fw-bold mb-2">Shipping Name <span class="text-danger">*</span></label>
                    ...
                    <div class="fv-row mb-9 fv-plugins-icon-container">
                        ...
                        <input type="text" class="form-control form-control-solid"  name="add_price">
                        @error('add_price')
                        <p class="text-danger">{{ $message }}</p>  
                        @enderror
                    </div>
