...
<div class="col-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Service List</span>  
            </h3>
                ...
                id="colorDatatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td>{{ $service->created_at->format('d Y M') }}</td>
                         <td>
                             <div class="d-flex justify-content-end flex-shrink-0">
                                 <a href="{{ route('backend.productmanagement.service.show', $service->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                 ...
                                 <a href="{{ route('backend.productmanagement.service.edit', $service->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                 ...
                                 <form method ="POST" action="{{ route('backend.productmanagement.service.destroy', $service->id) }}">
                                     @csrf
                                     @method('delete')
...
<div class="col-xl-4">
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Create Service</span>  
            </h3>
        </div>
            <div class="card-body py-3">
